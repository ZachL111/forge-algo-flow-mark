...
forge-algo-flow-mark is a OCaml project for algorithms. It focuses on this technical goal: Package an OCaml local lab for flow analysis with layout fixtures, stable geometry snapshots, and documented operating limits.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 154, risk penalty 6, latency penalty 2, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
