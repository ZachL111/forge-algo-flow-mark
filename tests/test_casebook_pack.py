"""Regression checks for the forge-algo-flow-mark casebook."""
...
from casebook.harness import assert_expected, forge_algo_flow_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(forge_algo_flow_mark_summary(), assert_expected())
